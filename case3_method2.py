...
from surface_tension import SummationDensitySourceMass, SolidWallPressureBCnoDensity, FindMaxddelta, MomentumEquationPressureGradientMorris, MomentumEquationViscosityMorris
...
class MultiPhase(Application):
    ...
    def create_solver(self):
        ...
        solver = Solver(
            ...
            dt=dt, tf=tf, adaptive_timestep=False, output_at_times=[0.0, 0.08, 0.16, 0.26])
        return solver
    ...
    def create_equations(self):
        morris_equations = [
            ...
            Group(equations=[
                ...
                SolidWallPressureBCnoDensity(dest='wall', sources=['fluid'], rho0=rho1, p0=p1),
                SmoothedColor(
                    dest='fluid', sources=[
                        'fluid', 'wall']),
                SmoothedColor(
